...
namespace SampleWeb.API
{
    ...
    public class SuppliersController : ControllerBase
    {
        ...
        // GET: api/Suppliers
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Supplier>>> API_GetSuppliers()
        {
          if (_context.Suppliers == null)
          {
            ...
            //return this.sup.GetSuppliers()
            //    .Include(s => s.City)
            //    .Include(s => s.Country)
            //    .Include(s => s.SupplierType)
            //    .ToList();

            return this.GetSuppliers().ToList();
        ...
        public async Task<ActionResult<Supplier>> PostSupplier(Supplier supplier)
        {
          if (_context.Suppliers == null)
          {
              return Problem("Entity set 'SampleWebContext.Suppliers'  is null.");
          }
